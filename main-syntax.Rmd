...
set.seed(123)
HB_2 <- saeHB::Beta(formula = APS_Disab ~ 
                      Persen_desa_dalam_hutan +
                      Persen_desa_luar_hutan, 
                    iter.update = 225, 
                    iter.mcmc = 60000, 
...
# Cek RSE
summary(
  as.data.frame(HB_2$Est$SD/HB_2$Est$MEAN*100) %>%
  mutate(
    RSE = as.factor(ifelse(HB_2$Est$SD/HB_2$Est$MEAN*100 >= 50, ">=50%",
                           ifelse(HB_2$Est$SD/HB_2$Est$MEAN*100 >= 25, ">=25%",
                                  "<25%")))
    )
)
...
# HB_2$Est$RSE <- HB_2$Est$SD/HB_2$Est$MEAN*100
# hasil_final_2 <- HB_2$Est[,-c(4:6)]

# write.csv(hasil_final_2, "Hasil_Final_2.csv")
```
...
set.seed(123)
HB_3 <- saeHB::Beta(formula = APS_Disab ~ 
                      Persen_desa_dalam_hutan +
                      Persen_desa_luar_hutan, 
                    iter.update = 230, 
                    iter.mcmc = 60000, 
...
# Cek RSE
summary(
  as.data.frame(HB_3$Est$SD/HB_3$Est$MEAN*100) %>%
  mutate(
    RSE = as.factor(ifelse(HB_3$Est$SD/HB_3$Est$MEAN*100 >= 50, ">=50%",
                           ifelse(HB_3$Est$SD/HB_3$Est$MEAN*100 >= 25, ">=25%",
                                  "<25%")))
    )
)
...
# HB_3$Est$RSE <- HB_3$Est$SD/HB_3$Est$MEAN*100
# hasil_final_3 <- HB_3$Est[,-c(4:6)]

# write.csv(hasil_final_3, "Hasil_Final_3.csv")
```
...
set.seed(123)
HB_4 <- saeHB::Beta(formula = APS_Disab ~ 
                      Persen_desa_dalam_hutan +
                      Persen_desa_luar_hutan, 
                    iter.update = 235, 
                    iter.mcmc = 60000, 
...
# Cek RSE
summary(
  as.data.frame(HB_4$Est$SD/HB_4$Est$MEAN*100) %>%
  mutate(
    RSE = as.factor(ifelse(HB_4$Est$SD/HB_4$Est$MEAN*100 >= 50, ">=50%",
                           ifelse(HB_4$Est$SD/HB_4$Est$MEAN*100 >= 25, ">=25%",
                                  "<25%")))
    )
)
...
# HB_4$Est$RSE <- HB_4$Est$SD/HB_4$Est$MEAN*100
# hasil_final_4 <- HB_4$Est[,-c(4:6)]

# write.csv(hasil_final_4, "Hasil_Final_4.csv")
```
...
set.seed(123)
HB_5 <- saeHB::Beta(formula = APS_Disab ~ 
                      Persen_desa_dalam_hutan +
                      Persen_desa_luar_hutan, 
                    iter.update = 240, 
                    iter.mcmc = 60000, 
...
# Cek RSE
summary(
  as.data.frame(HB_5$Est$SD/HB_5$Est$MEAN*100) %>%
  mutate(
    RSE = as.factor(ifelse(HB_5$Est$SD/HB_5$Est$MEAN*100 >= 50, ">=50%",
                           ifelse(HB_5$Est$SD/HB_5$Est$MEAN*100 >= 25, ">=25%",
                                  "<25%")))
    )
)
...
# HB_5$Est$RSE <- HB_5$Est$SD/HB_5$Est$MEAN*100
# hasil_final_5 <- HB_5$Est[,-c(4:6)]

# write.csv(hasil_final_5, "Hasil_Final_5.csv")
```
