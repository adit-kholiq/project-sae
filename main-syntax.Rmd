...
View(table(factor(gab$Provinsi),factor(gab$kat_Disab)))
...
Disab <- data_olahan[,c(1,2,5,8:16,20:22,24,29:31,40,42,47,51:53,56:58,61,63)] %>%
  mutate(
    ...
    APS_Disab = ifelse(APS_Disab == 1, 0.9999, 
                       ifelse(APS_Disab == 0, 0.0001, APS_Disab)),
    jumlah_SKTM = jumlah_SKTM/1000,
