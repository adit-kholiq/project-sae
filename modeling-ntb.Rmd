...
## Persiapan Untuk Plot Konvergensi HB
```{r}
library(coda)
...
plot_konvergen(NTB_HB3)
plot_konvergen(NTB_HB4)
```
...
summary(NTB_HB3$Est$SD/NTB_HB3$Est$MEAN*100)

# Simpan Hasil
NTB_HB3$Est$RSE <- NTB_HB3$Est$SD/NTB_HB3$Est$MEAN*100
NTB_hasil_rasio <- NTB_HB3$Est[,-c(4:6)]
...
summary(NTB_HB4$Est$SD/NTB_HB4$Est$MEAN*100)

# Simpan Hasil
NTB_HB4$Est$RSE <- NTB_HB4$Est$SD/NTB_HB4$Est$MEAN*100
NTB_hasil_rasio <- NTB_HB4$Est[,-c(4:6)]
#write.csv(NTB_hasil_rasio, "NTB_hasil_rasio(1).csv")
